...
public class UserService {
    ...
    public static Vector<Book> getUserList() {
        ...
        bookList.add(book);
        book = new Book("Fairy tales ", "Hans Christian Andersen ", "1835–37 ", "Denmark ", "Danish");
        bookList.add(book);
        
        book = new Book("511352312 Fall Apart ", "Chinua Achebe ", "1958", " Nigeria ", "English");
        bookList.add(book);
      
        book = new Book("The Divine Comedy ", "Dante Alighieri ", "1265–1321 ", "Florence ", "Italian");
        bookList.add(book);
        ...
        bookList.add(book);
        book = new Book("One Thousand and One Nights ", "Anonymous ", "700–1500 ", "India/Iran/Iraq/Egypt ", "Arabic");
        bookList.add(book);
        book = new Book("Njál's Saga ", "Anonymous ", "13th century ", "Iceland ", "Old Norse");
        bookList.add(book);
        book = new Book("Pride and Prejudice ", "Jane Austen ", "1813", " United Kingdom ", "English");
        bookList.add(book);
        book = new Book("Le Père Goriot ", "Honoré de Balzac ", "1835", " France ", "French");
        bookList.add(book);
        ...
        bookList.add(book);
        book = new Book("Wuthering Heights ", "Emily Brontë ", "1847", "  United Kingdom ", "English");
        bookList.add(book);
        ...
        bookList.add(book);
        book = new Book("Journey to the End of the Night ", "Louis-Ferdinand Céline ", "1932", "  France ", "French");
        bookList.add(book);
        ...
        bookList.add(book);
        book = new Book("Berlin Alexanderplatz ", "Alfred Döblin ", "1929", " Germany ", "German");
        bookList.add(book);
        ...
        bookList.add(book);
        book = new Book("Gypsy Ballads ", "Federico García Lorca ", "1928", " Spain ", "Spanish");
        bookList.add(book);
        book = new Book("One Hundred Years of Solitude ", "Gabriel García Márquez ", "1967", "    Colombia ", "Spanish");
        bookList.add(book);
        book = new Book("Love in the Time of Cholera ", "Gabriel García Márquez ", "1985", "  Colombia ", "Spanish");
        bookList.add(book);
        ...
        bookList.add(book);
        book = new Book("The Tin Drum ", "Günter Grass ", "1959", "   West Germany ", "German");
        bookList.add(book);
        book = new Book("The Devil to Pay in the Backlands ", "João Guimarães Rosa ", "1956", "   Brazil ", "Portuguese");
        bookList.add(book);
        ...
        bookList.add(book);
        book = new Book("Independent People ", "Halldór Laxness ", "1934–35 ", "Iceland ", "Icelandic");
        bookList.add(book);
        ...
        bookList.add(book);
        book = new Book("The Life of Gargantua and of Pantagruel ", "François Rabelais ", "1532–34 ", "France ", "French");
        bookList.add(book);
        book = new Book("Pedro Páramo ", "Juan Rulfo ", "1955", " Mexico ", "Spanish");
        bookList.add(book);
        ...
        bookList.add(book);
        book = new Book("Blindness ", "José Saramago ", "1995", " Portugal ", "Portuguese");
        bookList.add(book);
        ...
        bookList.add(book);
        book = new Book("9228241614 Fall Apart ", "Chinua Achebe ", "1958", " Nigeria ", "English");
        bookList.add(book);
